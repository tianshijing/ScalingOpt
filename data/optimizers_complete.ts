...
export const optimizers: Optimizer[] = [
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/tianshijing/ScalingOpt/blob/main/Optimizers/apollo.py'
  },
  {
    id: 'sam',
    name: 'SAM',
    ...
    githubUrl: 'https://github.com/tianshijing/ScalingOpt/blob/main/Optimizers/sam.py'
  },
  {
    id: 'madgrad',
    name: 'MADGRAD',
