...
export const optimizers: Optimizer[] = [
  // First-order optimizers
  {
    ...
    popularity: 85,
    tags: ['foundational', 'momentum', 'simple'],
  ...
  },
  {
    ...
    popularity: 75,
    tags: ['momentum', 'acceleration', 'nesterov'],
  ...
  },
  {
    ...
    popularity: 60,
    tags: ['adaptive', 'resilient', 'small-networks'],
  ...
  // Adaptive optimizers
  {
    ...
    popularity: 70,
    tags: ['adaptive', 'sparse', 'subgradient'],
  ...
  },
  {
    ...
    popularity: 65,
    tags: ['adaptive', 'parameter-free', 'robust'],
  ...
  },
  {
    ...
    popularity: 80,
    tags: ['adaptive', 'rnn', 'non-stationary'],
  ...
  },
  {
    ...
    popularity: 95,
    tags: ['adaptive', 'momentum', 'popular'],
  ...
  },
  {
    ...
    popularity: 70,
    tags: ['adaptive', 'infinity-norm', 'stable'],
  ...
  },
  {
    ...
    popularity: 75,
    tags: ['large-batch', 'layer-wise', 'scaling'],
  ...
  },
  {
    ...
    popularity: 65,
    tags: ['hybrid', 'switching', 'generalization'],
  ...
  },
  {
    ...
    popularity: 70,
    tags: ['second-order', 'preconditioning', 'tensor'],
  ...
  },
  {
    ...
    popularity: 68,
    tags: ['quasi-hyperbolic', 'adaptive', 'momentum'],
  ...
  },
  {
    ...
    popularity: 65,
    tags: ['quasi-hyperbolic', 'momentum', 'nesterov'],
  ...
  },
  {
    ...
    popularity: 72,
    tags: ['adaptive', 'nonconvex', 'stable'],
  ...
  },
  {
    ...
    popularity: 78,
    tags: ['memory-efficient', 'large-models', 'factorized'],
  ...
  },
  {
    ...
    popularity: 68,
    tags: ['aggregated', 'momentum', 'stability'],
  ...
  },
  {
    ...
    popularity: 62,
    tags: ['pid-control', 'stability', 'convergence'],
  ...
  },
  {
    ...
    popularity: 65,
    tags: ['accelerated', 'online-learning', 'adaptive'],
  ...
  },
  {
    ...
    popularity: 75,
    tags: ['adaptive', 'bounded', 'generalization'],
  ...
  },
  {
    ...
    popularity: 82,
    tags: ['large-batch', 'layer-wise', 'bert'],
  ...
  },
  {
    ...
    paper: {
      ...
      authors: ['Michael R. Zhang', 'James Lucas', 'Jimmy Ba', 'Geoffrey E. Hinton']
    },
    advantages: [
    ...
    popularity: 78,
    tags: ['lookahead', 'wrapper', 'stability'],
  ...
  },
  {
    ...
    popularity: 80,
    tags: ['rectified', 'adaptive', 'stable'],
  ...
  },
  {
    ...
    paper: {
      ...
      authors: ['Ding-Xuan Zhou', 'Junchi Yan']
    },
    advantages: [
    ...
    popularity: 70,
    tags: ['adaptive', 'momentum', 'modulation'],
  ...
  },
  {
    ...
    popularity: 75,
    tags: ['nesterov', 'adaptive', 'momentum'],
  ...
  },
  {
    ...
    popularity: 72,
    tags: ['layer-wise', 'adaptive', 'deep-networks'],
  ...
  },
  {
    ...
    popularity: 68,
    tags: ['gradient-history', 'cnn', 'convergence'],
  ...
  // Second-order optimizers
  {
    ...
    popularity: 75,
    tags: ['second-order', 'hessian', 'nonconvex'],
  ...
  },
  {
    ...
    popularity: 78,
    tags: ['belief', 'adaptive', 'generalization'],
  ...
  },
  {
    ...
    paper: {
      ...
      authors: ['Byeongho Heo', 'Sanghyuk Chun', 'Seong Joon Oh', 'Dongyoon Han', 'Sangdoo Yun', 'Youngjoon Yoo', 'Changkyu Choi']
    },
    advantages: [
    ...
    popularity: 76,
    tags: ['weight-norm', 'generalization', 'stability'],
  ...
  },
  {
    ...
    popularity: 70,
    tags: ['projection', 'weight-norm', 'stability'],
  ...
  },
  {
    ...
    paper: {
      ...
      authors: ['Xuezhi Wang', 'Xiang Wang', 'Hao Yu']
    },
    advantages: [
      'Quasi-Newton method',
    ...
    popularity: 72,
    tags: ['quasi-newton', 'parameter-wise', 'nonconvex'],
  ...
  },
  {
    ...
    popularity: 85,
    tags: ['sharpness-aware', 'generalization', 'flat-minima'],
  ...
  },
  {
    ...
    popularity: 75,
    tags: ['momentum', 'adaptive', 'dual-averaged'],
  ...
  },
  {
    ...
    popularity: 80,
    tags: ['adaptive', 'nesterov', 'deep-models'],
  ...
  },
  {
    ...
    paper: {
      ...
      authors: ['Yang Luo', 'Xiaomeng Chu', 'Yiming Kang', 'Yinghao Xu', 'Yiping Lu', 'Chengfei Lv', 'Ye Yuan', 'Guanhong Wang']
    },
    advantages: [
    ...
    popularity: 75,
    tags: ['confidence-guided', 'memory-efficient', 'adaptive'],
  ...
  },
  {
    ...
    popularity: 82,
    tags: ['second-order', 'scalable', 'language-models'],
  ...
  },
  {
    ...
    paper: {
      ...
      authors: ['Yida Yin', 'Zheng Qu', 'Peter Richtárik']
    },
    advantages: [
      'Variance reduction',
    ...
    popularity: 70,
    tags: ['variance-reduction', 'confidence-guided', 'convergence'],
  ...
  },
  {
    ...
    popularity: 78,
    tags: ['parameter-free', 'adaptive', 'distance-estimation'],
  ...
  },
  {
    ...
    popularity: 88,
    tags: ['evolved', 'sign-based', 'memory-efficient'],
    githubUrl: 'https://github.com/google-research/lion'
  },
  // Additional optimizers from the file list
  {
    id: 'sgdw',
    name: 'SGDW',
    ...
    popularity: 72,
    tags: ['weight-decay', 'sgd', 'baseline'],
    githubUrl: 'https://github.com/tianshijing/ScalingOpt/blob/main/Optimizers/sgdw.py'
  }
]

// Export categories and years for filtering
export const categories = ['All', 'First-order', 'Second-order', 'Adaptive', 'Momentum-based', 'Novel']

export const years = Array.from(new Set(optimizers.map(opt => opt.year))).sort((a, b) => b - a)
