...
import { GraduationCap, Calendar, ExternalLink, Search, Filter, TrendingUp, BookOpen } from 'lucide-react'
...
interface Paper {
  ...
  year: number
  venue: string
  category: 'Foundational' | 'Adaptive' | 'Second-order' | 'Novel' | 'Survey'
  abstract: string
  arxivUrl: string
  tags: string[]
  featured: boolean
...
export default function PapersPage() {
  ...
  const categories = ['All', 'Foundational', 'Adaptive', 'Second-order', 'Novel', 'Survey']
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-blue-700 max-w-3xl mx-auto">
            Explore foundational and cutting-edge research papers in optimization algorithms.
            From seminal works to the latest breakthroughs in scalable optimization.
          </p>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label htmlFor="search" className="block text-sm font-medium text-gray-700 mb-2">Search Papers</label>
        ...
        <div
          className="space-y-6"
        >
          <h2 className="text-2xl font-bold text-blue-900 mb-6">Research Papers</h2>
          {filteredPapers.length > 0 ? (
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-6">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-3">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getCategoryColor(paper.category)}`}>
                        {paper.category}
                      </span>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                Papers will appear here once they are added to the database.
              </p>
            </div>
          )}
        </div>
        ...
        >
          <h3 className="text-2xl font-bold mb-4">Have a Paper to Recommend?</h3>
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Help us grow our library! Suggest important research papers on optimization algorithms.
          </p>
          <a
            href="https://github.com/tianshijing/ScalingOpt/issues/new?assignees=&labels=enhancement%2Cpaper&projects=&template=2-paper-suggestion.md&title=Paper+Suggestion%3A+"
            target="_blank"
            rel="noopener noreferrer"
